...
namespace WpfMrpSimulatorApp.Helpers
{
    ...
    {
        // DB연결 문자열
        public static readonly string CONNSTR = "Server=localhost;Database=miniproject;Uid=root;Password=12345;Charset=utf-8";

        // MahApps.Metro 다이얼로그 코디네어터(MVVM에서 사용하기 위해서)
